...
CircuitBreakerHandler.PRIORITY = tonumber(os.getenv("PRIORITY_CIRCUIT_BREAKER")) or 920

kong.log.info(
    "Plugin priority set to "
    .. CircuitBreakerHandler.PRIORITY
    .. (os.getenv("PRIORITY_CIRCUIT_BREAKER") and " from env" or " by default")
)
